...
const CoreValues = () => {
  return (
    <div id="core-values" className="w-[90%] mx-auto py-10 md:py-20">
      <div className="w-[90%] rounded-xl core-values py-10 md:py-20 mx-auto">
        <h1 className="text-white text-[12px]  text-center md:text-xl font-normal Inter uppercase leading-normal tracking-wider">
          our core values
        </h1>
        <div className="grid grid-cols-1 space-y-2 md:space-y-0 px-8 my-8 md:mt-20 md:grid-cols-3">
          <div className="flex flex-col items-center flex-wrap">
            <span className="mb-2">
              <img src={Core} alt="core icon" className="w-6 md:w-full" />
            </span>
            <h1 className=" text-white text-[12px] md:text-3xl font-normal  uppercase">
              INTEGRITY
            </h1>
            <p className=" text-center text-white px-3 text-[8px] md:text-sm font-normal Inter">
        ...
        <div className="md:flex  px-8 md:px-0 max-w-6xl mx-auto md:mt-40">
          ...
          <div className="flex mt-6 md:mt-0  flex-col w-full items-center flex-wrap">
            <span className="mb-2">
              <img src={Core} alt="core icon" className="w-6 md:w-full" />
            </span>
            <h1 className=" text-white text-[12px] md:text-3xl font-normal  uppercase">
