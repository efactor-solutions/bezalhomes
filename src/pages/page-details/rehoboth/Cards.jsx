  ...
  return (
    <div className="flex lg:hidden py-10">
      <div className="w-[90%] flex flex-col space-y-4 items-center m-auto">
        ...
        <div className="px-8 w-full  py-5 flex ml-7 gap-8 justify-start items-center  bg-slate-50 rounded-[10px]">
          <div className="w-[27px] h-[27px]">
            <img src={DuplexD} alt="Icon" className="w-full" />
          </div>
          <div className=" text-zinc-800 text-[14px] justify-between font-normal Inter leading-[27px] tracking-[0.45px]">
