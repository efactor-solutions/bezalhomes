...
const Information = () => {
  return (
    <div className="w-[90%] m-auto py-20 lg:py-28 relative md:mb-8">
      ...
      <div className=" text-black text-[12px] md:mt-4 md:text-xl font-normal Inter mt-2 md:leading-[34px] tracking-wide">
      ...
      <div className="lg:absolute lg:bottom-0 right-[4%] mt-2 cursor-pointer">
        <img
          src={GetInTouch}
          alt="Button"
