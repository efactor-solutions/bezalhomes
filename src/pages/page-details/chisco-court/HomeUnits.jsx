...
import HomeUnit from "../../../assets/HomeUnits.svg";
    ...
    <main className="w-full lg:mt-[200px] h-full">
      <div className="w-full lg:relative flex flex-col lg:h-[807px] pb-[8rem] bg-zinc-300">
        ...
        <div className=" lg:absolute top-[10%] right-[10%]">
          ...
          <div className="w-full ml-8 lg:ml-0 grid lg:grid-cols-2 mt-6  lg:mt-[4rem] gap-7 lg:gap-[4rem]">
            <div className="w-[286.19px] h-[69.10px] pl-[23.19px] border-l border-slate-900 border-opacity-30 flex-col justify-center items-start inline-flex">
              ...
              <div className="text-black text-opacity-50 text-xs font-normal Inter leading-none">
                4 BEDROOM DETACHED HOUSE WITH 2 ROOM BQ
              </div>
            </div>
            <div className="w-[286.19px] h-[69.10px] pl-[23.19px] border-l border-slate-900 border-opacity-30 flex-col justify-center items-start inline-flex">
              <div className="text-zinc-800 text-[25px] flex items-center gap-4 lg:text-[31.25px] font-normal Inter leading-[53.10px]">
            ...
            <div className="w-[286.19px] h-[69.10px] pl-[23.19px] border-l border-slate-900 border-opacity-30 flex-col justify-center items-start inline-flex">
              ...
              <div className="text-black text-opacity-50 text-xs font-normal Inter leading-none">
              4 BEDROOM TERRACE WITH 1ROOM BQ
              </div>
            </div>
            <div className="w-[286.19px] h-[69.10px] pl-[23.19px] border-l border-slate-900 border-opacity-30 flex-col justify-center items-start inline-flex">
              <div className="text-zinc-800 text-[25px] flex items-center gap-4 lg:text-[31.25px] font-normal Inter leading-[53.10px]">
              ...
              <div className="text-black text-opacity-50 text-xs font-normal Inter leading-none">
              4 BEDROOM MANSION PEN-THOUSE WITH BQ, CINEMA
              </div>
            </div>
            <div className="w-[286.19px] h-[69.10px] pl-[23.19px] border-l border-slate-900 border-opacity-30 flex-col justify-center items-start inline-flex">
              <div className="text-zinc-800 text-[25px] flex items-center gap-4 lg:text-[31.25px] font-normal Inter leading-[53.10px]">
              ...
              <div className="text-black text-opacity-50 text-xs font-normal Inter leading-none">
              3 BEDROOM APARTMENT PENTHOUSE WITH CINEMA
              </div>
            </div>
            <div className="w-[286.19px] h-[69.10px] pl-[23.19px] border-l border-slate-900 border-opacity-30 flex-col justify-center items-start inline-flex">
              <div className="text-zinc-800 text-[25px] flex items-center gap-4 lg:text-[31.25px] font-normal Inter leading-[53.10px]">
          ...
          <div className="text-white text-[25px] font-normal  leading-[18.20px] tracking-wide">100 Units in total </div>
          </div>
          <img
            src={UnitSpinner}
            alt=""
            className="block animate-spin spinner lg:hidden  absolute right-[1%]"
          />
        </div>
      </div>
    </main>
