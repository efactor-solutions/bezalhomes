...
const RehobothGallery = () => {
  ...
  const handleMovePrev = () => {
    setLightboxIndex(
      (prevIndex) => (prevIndex + activeImages.length - 1) % activeImages.length
    );
  };
  ...
  const activeImages =
    activeTab === "architecture" ? architecture : workInProgress;
    ...
    <div className="w-full lg:py-20">
      <div className="w-[90%] m-auto py-10">
        ...
        <div className="flex gap-4 md:gap-8 mt-10 ">
          <div
            className={`tab cursor-pointer font-[400] text-[12px] md:text-[25px] ${
              activeTab === "architecture"
                ? "active text-[#E9682B] border-b border-b-[#E9682B]"
                : "text-[#333333]"
            }`}
