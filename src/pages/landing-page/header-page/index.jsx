      ...
      <div className="video-container">
        ...
        <div className="content flex justify-center items-center">
          <div className="flex flex-col gap-4 text-center w-full max-w-7xl">
            ...
            <h1 className="text-[#E9682B] uppercase Outfit font-bold text-lg md:text-4xl">
              Where Your Dream Home Awaits You!
            </h1>
            <p className="text-white inter max-w-xl md:mt-4 text-center self-center font-normal text-xs md:text-xl">
