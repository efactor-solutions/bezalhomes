    ...
    <main className="w-[90%] mx-auto py-10">
      <div>
        <div className="head flex justify-between items-center">
          ...
          <span>
           <img src={Share} alt="fun" className="w-[70%] md:w-full " />
           </span>
        ...
        <div className=" mt-6">
          ...
          <p className="text-zinc-800 text-[12px]  md:text-xl leading-4  font-normal  Inter">
            <br />
        ...
        <div className="">
          ...
          <p className="text-zinc-800 text-xs md:text-xl leading-4 font-normal  Inter">
            <br />
        ...
        <span className="text-zinc-800 text-sm md:text-xl font-normal  Inter underline">
          ...
          <p className="text-zinc-800 text-xs md:text-xl font-normal leading-4  Inter">
            <br />
